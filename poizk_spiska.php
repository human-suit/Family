...
<?php
		exit();
			...
			$poisk_date = mysqli_query($mysql, "SELECT name_kto FROM `spiski` WHERE `id_accounta` LIKE $User_id AND month(date_s) LIKE '$name_name' ORDER BY `spiski`.`id_spiska` DESC");
		$poisk_dat = mysqli_query($mysql, "SELECT type_s FROM `spiski` WHERE `id_accounta` LIKE $User_id AND month(date_s) LIKE '$name_name' ORDER BY `spiski`.`id_spiska` DESC");
		$poisk_da = mysqli_query($mysql, "SELECT price FROM `spiski` WHERE `id_accounta` LIKE $User_id AND month(date_s) LIKE '$name_name' ORDER BY `spiski`.`id_spiska` DESC");
		$poisk_d = mysqli_query($mysql, "SELECT date_s FROM `spiski` WHERE `id_accounta` LIKE $User_id AND month(date_s) LIKE '$name_name' ORDER BY `spiski`.`id_spiska` DESC");
		$poisk = mysqli_query($mysql, "SELECT name_type_s FROM `spiski` WHERE `id_accounta` LIKE $User_id AND month(date_s) LIKE '$name_name' ORDER BY `spiski`.`id_spiska` DESC");
